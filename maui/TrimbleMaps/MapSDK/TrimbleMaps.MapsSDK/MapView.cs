...
namespace TrimbleMaps.Controls.Forms
{
    public partial class MapView : View
    {
        ...
        public static BindableProperty UserLocationTrackingProperty = BindableProperty.Create(
            nameof(UserLocationTracking),
            typeof(UserTracking),
            typeof(MapView),
            default(UserTracking),
            BindingMode.OneWay
        );
        public UserTracking UserLocationTracking
        {
            get { return (UserTracking)GetValue(UserLocationTrackingProperty); }
            set { SetValue(UserLocationTrackingProperty, value); }
        }
