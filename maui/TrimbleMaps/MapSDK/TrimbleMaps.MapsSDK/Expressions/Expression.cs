...
namespace TrimbleMaps.MapsSDK.Expressions
{
    public partial class Expression
    {
        ...
        {
            return Match(Join(Join(new Expression[] { input }, TrimbleMaps.MapsSDK.Expressions.Stop.ToExpressionArray(stops)), new Expression[] { defaultOutput }));
        }
         ...
         * @return expression
         * @see <a href="https://www.MapsSDK.com/MapsSDK-gl-js/style-spec/#expressions-types-format">Style specification</a>
         */
        ...
        {
            return Step(Literal(input), defaultOutput, TrimbleMaps.MapsSDK.Expressions.Stop.ToExpressionArray(stops));
        }
        ...
        {
            return Step(input, defaultOutput, TrimbleMaps.MapsSDK.Expressions.Stop.ToExpressionArray(stops));
        }
