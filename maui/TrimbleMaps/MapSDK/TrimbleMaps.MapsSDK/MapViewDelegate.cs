...
namespace TrimbleMaps.Controls.Forms
{
    public partial class MapView
    {
        ...
        public static readonly BindableProperty UserMovedRegionCommandProperty = BindableProperty.Create(
                    nameof(UserMovedRegionCommand),
                    typeof(ICommand),
                    typeof(MapView),
                    default(ICommand),
                    BindingMode.OneWay);
        public ICommand UserMovedRegionCommand
        {
            get => (ICommand)GetValue(UserMovedRegionCommandProperty);
            set => SetValue(UserMovedRegionCommandProperty, value);
        }
