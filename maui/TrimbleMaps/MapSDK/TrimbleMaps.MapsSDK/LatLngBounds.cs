...
namespace TrimbleMaps.MapsSDK
{
    public struct LatLngBounds : IEquatable<LatLngBounds>
    {
        ...
        {
            var lat = (SouthWest.Lat + NorthEast.Lat) / 2.0;
            var lon = (SouthWest.Long + NorthEast.Long) / 2.0;
        ...
        public static LatLngBounds USA = new LatLngBounds(
                new LatLng(24.396308, -124.848974),
                new LatLng(49.384358, -66.885444) );
    }
