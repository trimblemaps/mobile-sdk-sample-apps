...
namespace TrimbleMaps.Controls.MapsSDK.Platform.iOS
{
    public partial class MapViewRenderer : ViewRenderer<MapView, MGLMapView>, IMGLMapViewDelegate, IUIGestureRecognizerDelegate
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                map.UserTrackingMode = Element.UserLocationTracking.ToNative();
            }
        }

        protected void OnElementPropertyChanging(object sender, Microsoft.Maui.Controls.PropertyChangingEventArgs e)
        {
        ...
        protected virtual void SetupUserInterface()
        {
            map = new MGLMapView(Bounds)
            {
                ...
                UserTrackingMode = Element.UserLocationTracking.ToNative(),
            ...
            var panRecognizer = new UIPanGestureRecognizer(UserMovedRegion);
        ...
        private void UserMovedRegion(UIPanGestureRecognizer recognizer)
        {
        ...
        protected virtual void UpdateContentInset(bool animated = true)
        {
            ...
            var contentInset = map.ContentInset.ToEdgeInsets();

            if (contentInset == Element.ContentInset) return;

            if (animated)
            {
                map.SetContentInset(Element.ContentInset.ToEdgeInsets(), true, null);
            }
            else
            {
                map.ContentInset = Element.ContentInset.ToEdgeInsets();
            }
        }
