...
using Com.Trimblemaps.Mapsdk.Style.Layers;
using NxLayer = TrimbleMaps.MapsSDK.Layers.Layer;
using NxCircleLayer = TrimbleMaps.MapsSDK.Layers.CircleLayer;
using NxFillExtrusionLayer = TrimbleMaps.MapsSDK.Layers.FillExtrusionLayer;
using NxFillLayer = TrimbleMaps.MapsSDK.Layers.FillLayer;
using NxForegroundLayer = TrimbleMaps.MapsSDK.Layers.ForegroundLayer;
using NxHeatmapLayer = TrimbleMaps.MapsSDK.Layers.HeatmapLayer;
using NxHillshadeLayer = TrimbleMaps.MapsSDK.Layers.HillshadeLayer;
using NxSymbolLayer = TrimbleMaps.MapsSDK.Layers.SymbolLayer;
using NxStyleLayer = TrimbleMaps.MapsSDK.Layers.StyleLayer;
using NxLineLayer = TrimbleMaps.MapsSDK.Layers.LineLayer;
using NxRasterLayer = TrimbleMaps.MapsSDK.Layers.RasterLayer;
...
namespace TrimbleMaps.Controls.MapsSDK.Platform.Droid
{
    ...
    public static partial class LayerExtensions
    {
        ...
        static void UpdateLayer(SymbolLayer result, NxSymbolLayer layer)
        {
            ...
            {
                properties.Add(PropertyFactory.IconHaloWidth(layer.IconHaloWidth.ToNative()));
            }
        ...
        public static TransitionOptions ToNative(this TrimbleMaps.MapsSDK.TransitionOptions options)
        {
